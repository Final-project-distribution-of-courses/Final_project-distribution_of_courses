...
def student_best_bundle_per_budget_with_threads(prices: dict, instance: Instance, epsilon: any, initial_budgets: dict):
    """
    ...
    >>> student_best_bundle_per_budget_with_threads(prices, instance, epsilon,initial_budgets)
...
def find_budget_perturbation(initial_budgets: dict, epsilon: float, prices: dict, instance: Instance, t: Enum, use_threads):
    # return: new_budgets, norma, allocation, excess_demand
    logger.info("START find_budget_perturbation")
    if use_threads:
        map_student_to_best_bundle_per_budget = student_best_bundle_per_budget_with_threads(prices, instance, epsilon, initial_budgets)
    else:
